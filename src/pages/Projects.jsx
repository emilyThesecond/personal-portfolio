  ...
  return (
    ...
    <div className="projects-container">
      ...
      <div className="project">
        ...
        <a href="https://the-strokes-fan-page.vercel.app/"><button>live site</button></a>
        <a href="https://github.com/emilyThesecond/the-strokes-client"><button>Gitub</button></a>
      ...
      <div className="project">
        ...
        <a href=""></a>
        <a href="https://github.com/emilyThesecond/glaze-cookbook"><button>Gitub</button></a>
      ...
      <div className="project">
        <h1>Habitualize</h1>
        <a href="https://habitualize-07273966efbf.herokuapp.com/"><button>Live site</button></a>
        <a href="https://github.com/harmonica23/habitualize"><button>Gitub</button></a>
